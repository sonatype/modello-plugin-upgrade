    ...
    extends AbstractConversionGenerator
{
        ...
        throws ModelloException
    {
        ...
        Writer interfaceWriter = getFileWriter( dir, conversionInterface.getName( true ) + ".java" );
        Writer classWriter = getFileWriter( dir, basicConverterClass.getName( true ) + ".java" );
